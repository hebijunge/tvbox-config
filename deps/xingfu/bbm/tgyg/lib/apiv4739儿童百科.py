# coding=utf-8
# 儿童百科 TVBox Python 爬虫 (基于 base.spider 标准)
# 站点: https://www.bilibili.com/
# 数据: B站官方搜索/视频接口, 分类全部以儿童百科/科普相关关键词抓取
...
# 分类 = 关键词, “获取所有分类数据”
CATES = [
    {'type_id': '儿童百科', 'type_name': '儿童百科'},
    {'type_id': '科学探索', 'type_name': '科学探索'},
    {'type_id': '自然地理', 'type_name': '自然地理'},
    {'type_id': '动物世界', 'type_name': '动物世界'},
    {'type_id': '天文宇宙', 'type_name': '天文宇宙'},
    {'type_id': '历史文化', 'type_name': '历史文化'},
    {'type_id': '人体奥秘', 'type_name': '人体奥秘'},
    {'type_id': '恐龙世界', 'type_name': '恐龙世界'},
    {'type_id': '植物百科', 'type_name': '植物百科'},
    {'type_id': '海洋世界', 'type_name': '海洋世界'},
    {'type_id': '物理化学', 'type_name': '物理化学'},
    {'type_id': '生活百科', 'type_name': '生活百科'},
]
# 每个分类下再补一组备选关键词以获得更丰富的结果
EXTRA_KEYWORDS = {
    '儿童百科': ['儿童百科 科普 视频', '少儿百科 动画'],
    '科学探索': ['儿童科学 探索 纪录片', '科普动画 科学'],
    '自然地理': ['自然地理 儿童 纪录片', '地理科普 少儿'],
    '动物世界': ['动物世界 儿童 科普', '动物百科 少儿'],
    '天文宇宙': ['天文科普 儿童', '宇宙探索 儿童 纪录片'],
    '历史文化': ['历史文化 儿童 动画', '中国历史 少儿 科普'],
    '人体奥秘': ['人体奥秘 科普', '人体科学 儿童 动画'],
    '恐龙世界': ['恐龙世界 儿童 科普', '恐龙百科 动画'],
    '植物百科': ['植物百科 儿童 科普', '植物世界 少儿'],
    '海洋世界': ['海洋世界 儿童 纪录片', '海洋动物 科普 动画'],
    '物理化学': ['物理 实验 儿童 科普', '化学 实验 少儿 科普'],
    '生活百科': ['生活百科 儿童 科普', '生活常识 少儿 动画'],
}
