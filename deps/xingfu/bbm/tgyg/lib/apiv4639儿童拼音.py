# coding=utf-8
# 儿童拼音 TVBox Python 爬虫 (基于 base.spider 标准)
# 站点: https://www.bilibili.com/
# 数据: B站官方搜索/视频接口, 分类全部以拼音学习相关关键词抓取
...
# 分类 = 关键词, “获取所有分类数据”
CATES = [
    {'type_id': '拼音启蒙', 'type_name': '拼音启蒙'},
    {'type_id': '拼音儿歌', 'type_name': '拼音儿歌'},
    {'type_id': '汉语拼音', 'type_name': '汉语拼音'},
    {'type_id': '拼音教学', 'type_name': '拼音教学'},
    {'type_id': '拼音动画', 'type_name': '拼音动画'},
    {'type_id': '拼音字母', 'type_name': '拼音字母'},
    {'type_id': '声母韵母', 'type_name': '声母韵母'},
    {'type_id': '拼音学习', 'type_name': '拼音学习'},
    {'type_id': '拼音识字', 'type_name': '拼音识字'},
    {'type_id': '幼小衔接', 'type_name': '幼小衔接'},
    {'type_id': '一年级语文', 'type_name': '一年级语文'},
    {'type_id': '拼音拼读', 'type_name': '拼音拼读'},
]
