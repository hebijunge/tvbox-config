# -*- coding: utf-8 -*-
# 儿童硬笔 TVBox Python 爬虫 (基于 base.spider 标准)
# 站点: https://www.bilibili.com/
# 分类: 写字启蒙教程/叫叫硬笔书法/硬笔书法123节超好用/王洪涛高效练字课/书法全套课/汉字基本笔画部首入门
# 数据: B站官方搜索接口
# 播放: 直接返回真实视频播放地址,无需任何解析
...
class Spider(BaseSpider):
    ...
    CATEGORIES = [
        {"type_id": "写字启蒙教程", "type_name": "写字启蒙教程"},
        {"type_id": "叫叫硬笔书法", "type_name": "叫叫硬笔书法"},
        {"type_id": "硬笔书法123节超好用", "type_name": "硬笔书法123节超好用"},
        {"type_id": "王洪涛高效练字课", "type_name": "王洪涛高效练字课"},
        {"type_id": "书法全套课【168集全】", "type_name": "书法全套课【168集全】"},
        {"type_id": "1000+集全【汉字基本笔画部首入门】", "type_name": "1000+集全【汉字基本笔画部首入门】"},
    ]
    ...
    def homeVideoContent(self):
        result = {"list": []}
        try:
            items, _, _ = self._search_videos("儿童硬笔书法写字", 1, "click")
            for v in items[:30]:
                bvid = v.get("bvid", "")
                if not bvid:
                    continue
