...
# 初中教育相关分类
CATES = [
    {'type_id': 'math', 'type_name': '初中数学'},
    {'type_id': 'chinese', 'type_name': '初中语文'},
    {'type_id': 'english', 'type_name': '初中英语'},
    {'type_id': 'physics', 'type_name': '初中物理'},
    {'type_id': 'chemistry', 'type_name': '初中化学'},
    {'type_id': 'biology', 'type_name': '初中生物'},
    {'type_id': 'history', 'type_name': '初中历史'},
    {'type_id': 'geography', 'type_name': '初中地理'},
    {'type_id': 'politics', 'type_name': '初中道法'},
]
