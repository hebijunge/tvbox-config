# -*- coding: utf-8 -*-
# 儿童识字 TVBox Python 爬虫 (基于 base.spider 标准)
# 站点: https://www.bilibili.com/
# 分类: 汉字启蒙/拼音学习/识字卡片/笔画笔顺/偏旁部首/汉字故事/趣味识字/学前识字/一年级识字/国学启蒙/古诗识字/成语识字
# 数据: B站官方搜索接口
...
class Spider(BaseSpider):
    ...
    CATEGORIES = [
        {"type_id": "汉字启蒙", "type_name": "汉字启蒙"},
        {"type_id": "拼音学习", "type_name": "拼音学习"},
        {"type_id": "识字卡片", "type_name": "识字卡片"},
        {"type_id": "笔画笔顺", "type_name": "笔画笔顺"},
        {"type_id": "偏旁部首", "type_name": "偏旁部首"},
        {"type_id": "汉字故事", "type_name": "汉字故事"},
        {"type_id": "趣味识字", "type_name": "趣味识字"},
        {"type_id": "学前识字", "type_name": "学前识字"},
        {"type_id": "一年级识字", "type_name": "一年级识字"},
        {"type_id": "国学启蒙", "type_name": "国学启蒙"},
        {"type_id": "古诗识字", "type_name": "古诗识字"},
        {"type_id": "成语识字", "type_name": "成语识字"},
    ]
    ...
    def homeVideoContent(self):
        result = {"list": []}
        try:
            items, _, _ = self._search_videos("儿童识字 汉字 启蒙", 1, "click")
            for v in items[:30]:
                bvid = v.get("bvid", "")
                if not bvid:
                    continue
